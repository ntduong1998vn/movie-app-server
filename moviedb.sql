...
CREATE TABLE `actors` (
  ...
  `nation` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `actors` VALUES (1,'Lưu Diệp Phi','luu-diep-phi.jpg','China'),(2,'Huỳnh Hiểu Minh','luu-diep-phi.jpg','China'),(3,'Trịnh Khải','luu-diep-phi.jpg','Trung quốc'),(4,'Đặng Siêu','281dfc13204975c55a7d9b8af27cfe78.jpg','Mỹ'),(5,'Trấn Thành','tran-thanh.jpg','Việt Nam'),(6,'HariWon','hari-won.jpg','Korea');
...
CREATE TABLE `characters` (
  ...
  `character` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FKjk5cn95vpv3ireriydqqtox2c` (`actor_id`) USING BTREE,
  KEY `FK23f14xg9mbsj5lfl0ouoifrmu` (`movie_id`) USING BTREE,
...
INSERT INTO `characters` VALUES (1,15,1,'Wiliam'),(2,15,2,'John'),(4,16,1,'Adam John'),(5,17,2,'Smith'),(7,17,3,'Jessica');
...
CREATE TABLE `comments` (
  ...
  KEY `FK8omq0tc18jd43bu5tjh6jvraq` (`user_id`) USING BTREE,
...
CREATE TABLE `episodes` (
  ...
  KEY `FKr0m8qnjio0s9c6s53p68nxpg` (`movie_id`) USING BTREE,
...
CREATE TABLE `favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `current_time` time DEFAULT '00:00:00',
  `movies_id` int(11) NOT NULL,
  `users_id` int(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_favorites_movies1_idx` (`movies_id`),
  KEY `fk_favorites_users1_idx` (`users_id`),
  CONSTRAINT `fk_favorites_movies1` FOREIGN KEY (`movies_id`) REFERENCES `movies` (`id`),
...
CREATE TABLE `reviews` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK87tlqya0rq8ijfjscldpvvdyq` (`movie_id`) USING BTREE,
  KEY `FKcgy7qjc1r99dp117y9en6lxye` (`user_id`) USING BTREE,
...
CREATE TABLE `sources` (
  ...
  `movie_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK6xchmny0jro9vyw9p1t7cq83d` (`episode_id`,`movie_id`) USING BTREE,
...
CREATE TABLE `users` (
  ...
  `role` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'ROLE_USER',
...
-- Dump completed on 2020-07-04  9:14:55
